...
"$Name
$Path
$Input" | Set-Content "C:\Users\iqb_archivar\Desktop\Aufträge\auftrag_$creation_date.txt"
Write-Host "Der Auftrag wurde erstellt. Die gesammelten Informationen befinden sich in auftrag_$creation_date.txt"
